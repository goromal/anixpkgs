{
    ...
    anixdata = builtins.fetchGit {
        ...
        rev = "1cf9479ab29fdd50d1771dfaf83ebfeb2330dec6";
        ref = "master";
    };
    aapis = builtins.fetchGit {
        url = "https://github.com/goromal/aapis";
    ...
    geometry = builtins.fetchGit {
        url = "https://github.com/goromal/geometry";
        rev = "a5a5ed08b0daf7ef91b4ed342a9e407225b12ad0";
        ref = "main";
    };
    gmail-parser = builtins.fetchGit {
        url = "https://github.com/goromal/gmail_parser";
    ...
    mavlog-utils = builtins.fetchGit {
        url = "https://github.com/goromal/mavlog-utils";
    ...
    scrape = builtins.fetchGit {
        url = "https://github.com/goromal/scrape";
