            ...
            let
              ...
              serviceLinks = lib.concatMapStringsSep "\n" (
                ...
                if s.path == "#" then
                  ...
                  in
                  "    <li><a href=\"#\" onclick=\"window.location.href=window.location.protocol+String.fromCharCode(47,47)+window.location.hostname+String.fromCharCode(58)+'${port}/'; return false;\">${s.name}</a> - ${s.description}</li>"
                else
