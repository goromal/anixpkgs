{ lib, python, buildPythonPackage, fetchPypi, requests, watchdog, urllib3, tqdm
, plexapi, python-dotenv, psutil, pkg-src }:
let
...
in buildPythonPackage rec {
  ...
  propagatedBuildInputs =
    [ requests watchdog tmdbv3api tqdm psutil plexapi python-dotenv ];
